...
export const createMentor = async (
    ...
    let profile_image_binary = null;

    if (profile_image) {
        try {
            profile_image_binary = fs.readFileSync(profile_image);
        } catch (err) {
            throw "Error reading profile image file.";
        }
    }
    ...
    let newMentor = {
        ...
        email: email,
        pwd_hash: pwd_hash,
        profile_image: profile_image_binary,
